...
N 160 500 160 520 {lab=VSS}
N 160 420 160 440 {lab=S}
N 160 500 160 520 {lab=VSS}
N 160 420 160 440 {lab=S}
...
C {capa.sym} 160 470 0 0 {name=C5
m=1
value=5f
}
C {lab_wire.sym} 160 520 0 0 {name=p21 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 160 420 0 0 {name=p22 sig_type=std_logic lab=S}
C {capa.sym} 160 470 0 0 {name=C6
m=1
value=5f
}
C {lab_wire.sym} 160 520 0 0 {name=p23 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 160 420 0 0 {name=p24 sig_type=std_logic lab=S}
