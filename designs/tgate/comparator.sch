...
N 300 50 380 50 {lab=#net1}
N 380 50 380 60 {lab=#net1}
N 380 60 480 60 {lab=#net1}
N 480 50 480 60 {lab=#net1}
...
N -0 380 80 380 {lab=#net2}
N -0 380 -0 400 {lab=#net2}
N -80 380 -0 380 {lab=#net2}
N -0 430 0 540 {lab=VSS}
N 80 280 80 300 {lab=#net3}
N -80 280 -80 300 {lab=#net4}
...
N 480 50 560 50 {lab=#net1}
N 440 80 440 280 {lab=#net3}
N 80 280 440 280 {lab=#net3}
N -440 280 -80 280 {lab=#net4}
N -440 80 -440 280 {lab=#net4}
N -120 430 -40 430 {lab=CLK}
N 0 -80 0 -0 {lab=VDD}
N -80 0 0 -0 {lab=VDD}
N -80 260 -80 280 {lab=#net4}
N 80 260 80 280 {lab=#net3}
N -80 360 -80 380 {lab=#net2}
N 80 360 80 380 {lab=#net2}
