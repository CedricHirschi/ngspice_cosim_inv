...
N -1080 460 -1080 500 {lab=clk}
N -580 190 -580 460 {lab=clk}
N -1080 460 -580 460 {lab=clk}
C {comparator.sym} -420 190 0 0 {name=x1}
C {code_shown.sym} 420 -60 0 0 {name=MODEL only_toplevel=true
...
C {vsource.sym} -1080 530 0 0 {name=Vclk value="pulse(\{vss\}, \{vdd\}, \{0.1/f\}, 0.2n, 0.2n, \{0.5/f\}, \{1/f\})"}
C {gnd.sym} -1080 560 0 0 {name=l1 lab=GND}
...
C {vsource.sym} -900 150 0 0 {name=Vdiff value="pulse(\{vhigh/2\}, \{vlow/2\}, \{0.8/f\}, 0.2n, 0.2n, \{1/f\}, \{2/f\})"}
...
C {simulator_commands_shown.sym} 420 80 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
.param vss=0
...
.endc
"}
C {vsource.sym} -900 230 0 0 {name=Vdiff1 value="pulse(\{vhigh/2\}, \{vlow/2\}, \{0.8/f\}, 0.2n, 0.2n, \{1/f\}, \{2/f\})"}
