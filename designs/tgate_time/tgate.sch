...
N -50 -100 -30 -100 {lab=A}
N -260 400 -240 400 {lab=CTRL}
N -260 340 -260 400 {lab=CTRL}
N -300 400 -260 400 {lab=CTRL}
N -260 340 -240 340 {lab=CTRL}
N -0 140 -0 170 {lab=ctrl_ni}
N -0 -170 0 -140 {lab=ctrl_i}
N -160 340 -120 340 {lab=ctrl_i}
N -160 400 -120 400 {lab=ctrl_ni}
N 30 -100 50 -100 {lab=B}
N 30 100 50 100 {lab=B}
N -90 -0 -50 0 {lab=A}
N -50 -100 -50 0 {lab=A}
C {ipin.sym} -300 400 0 0 {name=p1 lab=CTRL}
...
C {lab_pin.sym} -120 340 2 0 {name=p10 sig_type=std_logic lab=ctrl_i}
C {lab_pin.sym} -120 400 2 0 {name=p11 sig_type=std_logic lab=ctrl_ni}
...
C {sg13g2_stdcells/sg13g2_inv_1.sym} -200 400 0 0 {name=x1 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_buf_1.sym} -200 340 0 0 {name=x2 VDD=VDD VSS=VSS prefix=sg13g2_ }
