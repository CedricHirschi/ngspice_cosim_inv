...
N -0 380 80 380 {lab=#net1}
N -0 380 -0 400 {lab=#net1}
N -80 380 -0 380 {lab=#net1}
...
N 440 80 440 280 {lab=#net2}
N 80 280 440 280 {lab=#net2}
N -440 280 -80 280 {lab=#net3}
N -440 80 -440 280 {lab=#net3}
N -120 430 -40 430 {lab=CLK}
N 0 -80 0 -0 {lab=VDD}
N -80 0 0 -0 {lab=VDD}
N -80 260 -80 280 {lab=#net3}
N 80 260 80 280 {lab=#net2}
N -80 360 -80 380 {lab=#net1}
N 80 360 80 380 {lab=#net1}
