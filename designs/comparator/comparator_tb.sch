...
x2.net2
x2.net2 x2.net3 -"}
B 2 -1200 -770 -400 -570 {flags=graph
ypos1=0
ypos2=2
divy=5
subdivy=1
...
node="out1_inv
out2_inv"}
B 2 -400 1200 400 1400 {flags=graph
y1=-0.25
ypos1=0
ypos2=2
divy=5
...
autoload=1
x1=2.0551603e-08}
B 2 -1200 -970 -400 -770 {flags=graph
y1=-0.25
ypos1=0
ypos2=2
divy=5
...
N 80 20 160 20 {lab=out2}
N -380 940 -380 960 {lab=out1_dup}
N -40 940 -40 960 {lab=out2_dup}
N -380 1800 -280 1800 {lab=out1}
N -220 1800 -80 1800 {lab=out1_inv}
N -280 1850 -260 1850 {lab=out1}
N -280 1800 -280 1850 {lab=out1}
N -280 1750 -280 1800 {lab=out1}
N -280 1750 -260 1750 {lab=out1}
N -220 1700 -220 1750 {lab=vdd}
N -220 1800 -220 1820 {lab=out1_inv}
N -220 1780 -220 1800 {lab=out1_inv}
N -220 1850 -220 1900 {lab=vss}
N -40 1800 60 1800 {lab=out2}
N 120 1800 260 1800 {lab=out2_inv}
N 60 1850 80 1850 {lab=out2}
N 60 1800 60 1850 {lab=out2}
N 60 1750 60 1800 {lab=out2}
N 60 1750 80 1750 {lab=out2}
N 120 1700 120 1750 {lab=vdd}
N 120 1800 120 1820 {lab=out2_inv}
N 120 1780 120 1800 {lab=out2_inv}
N 120 1850 120 1900 {lab=vss}
...
C {vsource.sym} -480 -40 0 0 {name=Vdiff value="pulse(\{vhigh/2\}, \{vlow/2\}, \{0.8/f\}, 1f, 1f, \{1/f\}, \{2/f\})"}
...
C {lab_wire.sym} 160 -20 0 0 {name=p8 sig_type=std_logic lab=out1}
C {lab_wire.sym} 160 20 0 0 {name=p9 sig_type=std_logic lab=out2}
...
C {lab_wire.sym} -300 1800 0 0 {name=p18 sig_type=std_logic lab=out1}
C {lab_wire.sym} -80 1800 0 0 {name=p19 sig_type=std_logic lab=out1_inv}
C {sg13g2_pr/sg13_lv_nmos.sym} -240 1850 0 0 {name=M5
l=0.13u
w=1.5u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} -240 1750 0 0 {name=M6
l=0.13u
w=0.15u
ng=1
m=1
...
C {lab_wire.sym} -220 1700 0 0 {name=p20 sig_type=std_logic lab=vdd}
C {lab_wire.sym} -220 1900 2 0 {name=p21 sig_type=std_logic lab=vss}
C {lab_wire.sym} 40 1800 0 0 {name=p22 sig_type=std_logic lab=out2}
C {lab_wire.sym} 260 1800 0 0 {name=p23 sig_type=std_logic lab=out2_inv}
C {sg13g2_pr/sg13_lv_nmos.sym} 100 1850 0 0 {name=M7
l=0.13u
w=1.5u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 100 1750 0 0 {name=M8
l=0.13u
w=0.15u
ng=1
m=1
...
C {lab_wire.sym} 120 1700 0 0 {name=p24 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 120 1900 2 0 {name=p25 sig_type=std_logic lab=vss}
...
C {vsource.sym} -480 40 0 0 {name=Vdiff1 value="pulse(\{vhigh/2\}, \{vlow/2\}, \{0.8/f\}, 1f, 1f, \{1/f\}, \{2/f\})"}
