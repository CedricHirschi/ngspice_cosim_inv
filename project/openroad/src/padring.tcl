...
set_io_pin_constraint -pin_names {start_i rdy_o} -region left:*
...
set_io_pin_constraint -pin_names {dac_n_o_0_ dac_n_o_1_ dac_n_o_2_ dac_n_o_3_ dac_n_o_4_ dac_n_o_5_ dac_n_o_6_} -region left:* -group -order
