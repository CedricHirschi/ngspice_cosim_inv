...
report_image "00_${proj_name}.power" false
...
report_image "${log_id_str}_${proj_name}.pre_place" false
...
set GPL_ARGS [list -density $TDENSITY]

set GPL2_ARGS [list -density $TDENSITY -routability_driven -routability_check_overflow 0.30 -timing_driven]
