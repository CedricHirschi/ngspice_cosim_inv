...
E {}
T {name=a1 model=adc
device_model=".model adc d_cosim simulation=\\"ivlng\\" sim_args=[\\"adc\\"]"} -40 -30 0 0 0.4 0.4 {}
...
N -160 -220 -120 -220 {lab=#net3}
N -160 -160 -120 -160 {lab=rst_ni}
N -160 -140 -120 -140 {lab=start_i}
N -260 -220 -220 -220 {lab=clk_digital_i}
N -160 -180 -120 -180 {lab=comp_p}
N -160 -200 -120 -200 {lab=comp_n}
N 120 -120 160 -120 {lab=sample_en}
N 120 -220 160 -220 {lab=compare_en}
N 120 -160 160 -160 {lab=ready_o}
N 120 -140 160 -140 {lab=result_o[7..0]}
N 120 -180 160 -180 {lab=dac_p[6..0]}
N 120 -200 160 -200 {lab=dac_n[6..0]}
C {./tgate.sym} -260 -950 0 0 {name=x1}
C {ipin.sym} -390 -950 0 0 {name=p1 lab=pos_ai}
C {ipin.sym} -500 20 0 0 {name=p5 lab=VSS}
C {ipin.sym} -500 0 0 0 {name=p6 lab=VDD}
...
C {ipin.sym} -500 -20 0 0 {name=p9 lab=rst_ni}
...
C {ipin.sym} -260 -220 0 0 {name=p48 lab=clk_digital_i}
C {ipin.sym} -160 -140 0 0 {name=p49 lab=start_i}
C {lab_pin.sym} -160 -160 0 0 {name=p50 sig_type=std_logic lab=rst_ni}
C {adc_bridge.sym} -190 -220 0 0 {name=A4 adc_bridge_model=adc_buff_clk}
C {lab_pin.sym} -160 -180 0 0 {name=p51 sig_type=std_logic lab=comp_p}
C {lab_pin.sym} -160 -200 0 0 {name=p52 sig_type=std_logic lab=comp_n}
C {lab_pin.sym} 160 -120 2 0 {name=p53 sig_type=std_logic lab=sample_en}
C {lab_pin.sym} 160 -220 2 0 {name=p54 sig_type=std_logic lab=compare_en}
C {opin.sym} 160 -160 0 0 {name=p55 lab=ready_o}
C {opin.sym} 160 -140 0 0 {name=p56 lab=result_o[7..0]}
C {lab_pin.sym} 160 -180 2 0 {name=p2 sig_type=std_logic lab=dac_p[6..0]}
C {lab_pin.sym} 160 -200 2 0 {name=p10 sig_type=std_logic lab=dac_n[6..0]}
C {adc_vlog.sym} 0 -220 0 0 {name=A1 model=adc device_model=".model adc d_cosim simulation=\\"ivlng\\" sim_args=[\\"adc\\"]"}
